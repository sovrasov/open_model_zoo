...
do
  ...
  python3 multi_camera_multi_person_tracking.py --config ./config.py -i $mot_root/MOT17-$seq-FRCNN/img1/ --mot_eval --history_file $output_folder/MOT17-$seq-FRCNN.json $detection_command
done
